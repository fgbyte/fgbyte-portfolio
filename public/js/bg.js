...
function initBG() {
	const particlesSmall = generateParticles(250);
	const particlesMedium = generateParticles(125);
	const particlesLarge = generateParticles(60);
	...
	const starsSmall = generateStars(250);
	const starsMedium = generateStars(125);
	const starsLarge = generateStars(60);
